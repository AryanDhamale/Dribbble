...
function Gallary() {
    ...
    return (
        <div className="mt-25 min-h-[100vh] flex flex-col gap-y-3">
            ...
            <div>
                <div className="w-[95%] mx-auto gap-x-6 gap-y-8 flex-1 px-4 py-4 flex justify-start items-center flex-wrap">
                    {
                        arr.map((ele, idx) =>
            ...
            {visible && <div className="w-full h-full fixed top-0 bottom-0 left-0 right-0 bg-[#000000eb] z-[3]">
                <div className="w-full h-full flex justify-center items-center relative">
                    ...
                    <Image width={100} height={100} unoptimized className="w-1/2 rounded-sm" src={current} alt="this is an image" />
                </div>
            </div>}
        </div>
    );
