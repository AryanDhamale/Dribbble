    ...
    return (
        <div className="mt-20 pt-5 flex flex-col py-8 gap-y-10 min-h-[100vh]">
            <div className="flex flex-col gap-y-4 justify-center items-center">
                ...
                <p className="text-base md:text-xl w-[90%] md:w-1/2 opacity-50">We are a passionate team of travelers who aim to make travel accessible, enjoyable, and memorable. Our platform connects you to the best destinations, helping you book hassle-free experiences worldwide.</p>
            </div>
            ...
            <div className="w-full md:w-[90%] mx-auto grid grid-col-1 md:grid-cols-2 gap-x-4">
                ...
                <div className="w-[90%] md:w-full text-xl flex flex-col gap-y-6">
            ...
            <div className="w-full md:w-[90%] mx-auto grid grid-col-1 md:grid-cols-2 gap-x-4">
                ...
                <div className="w-[90%] md:w-full text-xl flex flex-col justify-center">
