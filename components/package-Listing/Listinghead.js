...
function Listinghead({ data }) {
    return (
        <>
            <div className="mx-auto my-4 flex w-[90%]">

                <div className="w-[68%] flex flex-col px-6 gap-y-3 py-4">
                    <Image width={100} height={100} unoptimized className="w-[95%]  rounded-md block h-[30rem]" src={data.image} alt="this is an image" />
